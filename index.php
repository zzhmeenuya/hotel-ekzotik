...
<head>
	...
	<meta itemprop="image" content="assets/img/header/header-background.png" />

	<!-- Template meta SEO -END -->

	<!-- Template Basic Images Start -->
	<meta property="og:image" content="assets/img/header/header-background.png">
...
<body>
	...
	<!-- КАРТИНКА В ШАПКЕ -->
	<header class="header" style="background: url(assets/img/header/header-background.png) no-repeat top center / cover">
						...
						<div class="row">
							<div class="col-12">
								<div class="header__content header-conatainer-content">
									<img class="logo header__logo" src="assets/img/logo/logo.png" alt="hotel-ekzotik">
									<h1>hotel-ekzotik</h1>
									<h2>Сочи - Адлер</h2>
	...
	<main role="main">
									...
									<div class="col-12 col-md-8 room__slider">
										...
										<div class="swiper-container section-room-slider ">
											...
											<div class="swiper-wrapper">
												<!-- Slides -->
												<img class="swiper-slide" src="assets/img/rooms/room-1.png" alt="номер">
											</div>
											<div class="swiper-button-prev swiper-button"><img src="assets/img/rooms/arrow-left.png"
													alt="назад"></div>
											<div class="swiper-button-next swiper-button"><img src="assets/img/rooms/arrow-right.png"
													alt="вперед"></div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-12 col-md-8 room__slider">
										...
										<div class="swiper-container section-room-slider ">
											...
											<div class="swiper-wrapper">
												<!-- Slides -->
												<img class="swiper-slide" src="assets/img/rooms/room-2.png" alt="номер">
											</div>
											<div class="swiper-button-prev swiper-button"><img src="assets/img/rooms/arrow-left.png"
													alt="назад"></div>
											<div class="swiper-button-next swiper-button"><img src="assets/img/rooms/arrow-right.png"
								...
								<div class="row">
									<div class="col-12 col-md-8 room__slider">
										...
										<div class="swiper-container section-room-slider">
											...
											<div class="swiper-wrapper">
												<!-- Slides -->
												<img class="swiper-slide" src="assets/img/rooms/room-3.png" alt="номер">
											</div>
											<div class="swiper-button-prev swiper-button"><img src="assets/img/rooms/arrow-left.png"
													alt="назад"></div>
											<div class="swiper-button-next swiper-button"><img src="assets/img/rooms/arrow-right.png"
								...
								<div class="row">
									<div class="col-12 col-md-8 room__slider">
										...
										<div class="swiper-container section-room-slider ">
											...
											<div class="swiper-wrapper">
												<!-- Slides -->
												<img class="swiper-slide" src="assets/img/rooms/room-4.png" alt="номер">
											</div>
											<div class="swiper-button-prev swiper-button"><img src="assets/img/rooms/arrow-left.png"
													alt="назад"></div>
											<div class="swiper-button-next swiper-button"><img src="assets/img/rooms/arrow-right.png"
				...
				<div class="row justify-content-center">
					...
					<div class="section__content-container col-12 col-md-7">
						...
						<div class="section-video-slide__button-container d-flex">
							<div class="swiper-button-prev swiper-button"><img src="assets/img/rooms/arrow-left.png"alt="назад"></div>
							<div class="swiper-button-next swiper-button"><img src="assets/img/rooms/arrow-right.png"alt="вперед"></div>
						</div>
		...
		<section class="section section-gallery">
			...
			<div class="container-fluid">
				<div class="section-gallery__gallery-container popup-gallery">
					...
					<div class="section-gallery__gallery-row">
						<div class="row">
							<div class="col-12 col-md-8 section-gallery__gallery-column">
								<a href="assets/img/gallery/gallery-1.png" title="Отель Малахит" data-effect="mfp-move-horizontal">
									<img src="assets/img/gallery/gallery-1.png" alt="Отель Малахит" data-effect="mfp-move-horizontal">
								</a>
							</div>
							<div class="col-12 col-md-4 section-gallery__gallery-column section-gallery__gallery-column-left">
								<a href="assets/img/gallery/gallery-2.png" title="Отель Малахит">
									<img src="assets/img/gallery/gallery-2.png" alt="Отель Малахит">
								</a>
								<a href="assets/img/gallery/gallery-3.png" title="Отель Малахит">
									<img src="assets/img/gallery/gallery-3.png" alt="Отель Малахит">
								</a>
							</div>
						</div>
					</div>
					...
					<div class="section-gallery__gallery-row">
						<a href="assets/img/gallery/gallery-4.png" title="Отель Малахит">
							<img src="assets/img/gallery/gallery-4.png" alt="Отель Малахит">
						</a>
					</div>
		...
		<section class="section section_padding-0 section-reserve-room" style="background: #000 url(assets/img/order/order__background.png) no-repeat center center / cover">
